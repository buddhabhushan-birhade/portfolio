            ...
            <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center pt-24 pb-12">
                ...
                >
                    <div className="relative w-full max-w-lg aspect-square">
                        {/* Background Glow */}
                        <div className="absolute inset-0 bg-gradient-to-tr from-brand-orange/20 to-brand-amber/10 blur-3xl opacity-50 animate-pulse" />

                        {/* Image Placeholder Frame */}
                        <div className="relative z-10 w-full h-full glass-card border-brand-orange/20 overflow-hidden group shadow-2xl shadow-brand-orange/10 transform rotate-3 hover:rotate-0 transition-transform duration-700">
                            <img
                                src="/myimg.jpeg"
